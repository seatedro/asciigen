...
pub fn main() !void {
    ...
    const input = " .:-=+*%#@1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzé";
    const sorted = try sortCharsBySize(allocator, input);
    defer allocator.free(sorted);

    // You can use the sorted string here if needed
    // Note: sorted is now []const u8
}

//zig run stringSortTest.zig
//prints output of sorted
